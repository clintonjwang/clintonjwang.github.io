...
// The correct answer should be set in a global variable before this script loads
document.addEventListener('DOMContentLoaded', function() {
    if (typeof PUZZLE_ANSWER !== 'undefined') {
        new PuzzleChecker(PUZZLE_ANSWER);
    } else {
        console.error('PUZZLE_ANSWER not defined. Please set it before loading puzzle.js');
    }
}); 