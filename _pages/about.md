...
I am a PhD candidate at MIT CSAIL advised by [Polina Golland](https://people.csail.mit.edu/polina/). My research focuses on 3D vision, including neural fields and trajectory estimation. I also work on medical image analysis, particularly robust and interpretable techniques for both generative and discriminative models. I use diffusion models to make [things](#fun-ai-creations-more).
